...
export function ResetPassword() {
  ...
  return (
    ...
    >
      ...
      {erroDoLink && (
        <div className="mt-5 rounded-xl border border-[#f6ddb0] bg-[#fcf2d9] px-4 py-4">
          <p className="text-sm font-semibold text-[#78350f]">{erroDoLink.titulo}</p>
          <p className="mt-1 text-[13px] text-[#8a5a12]">{erroDoLink.mensagem}</p>
          {erroDoLink.pedirOutro && (
            <Link
              to="/recuperar-senha"
              className="mt-3 inline-flex items-center justify-center rounded-[10px] bg-forest-600 px-4 py-2.5 text-[13px] font-semibold text-white hover:bg-forest-700"
            >
