 ...
 *
 * Cópia da mesma tabela do Backoffice. Enquanto não existe um pacote
 * compartilhado, as duas precisam continuar dizendo a mesma coisa — o operador
 * e o escritório não podem ler explicações diferentes para o mesmo erro.
 *
